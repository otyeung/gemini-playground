...
export class AudioStreamer {
	 ...
	 * @param {number} [sampleRate] - Optional sample rate override. Defaults to CONFIG.AUDIO.OUTPUT_SAMPLE_RATE.
	 */
	constructor(context, sampleRate = null) {
		this.context = context;
		this.audioQueue = [];
		this.isPlaying = false;
		this.sampleRate = sampleRate || CONFIG.AUDIO.OUTPUT_SAMPLE_RATE;
	 ...
	 * @description Updates the sample rate for audio processing.
	 * @param {number} sampleRate - The new sample rate in Hz.
	 */
